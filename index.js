    ...
    for (let participant of participants) {
        try {
            ...
            if (action === 'add') {
                ...
                // Generate welcome image using PopCat API
                const welcomeImageUrl = `https://api.popcat.xyz/welcomecard?background=https://cdn.popcat.xyz/welcome-bg.png&text1=${encodeURIComponent(participantName)}&text2=Welcome+To+${encodeURIComponent(groupName)}&text3=Member+${encodeURIComponent(memberCount)}&avatar=${encodeURIComponent(ppUser)}`;
